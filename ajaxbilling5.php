...
else if($_POST['search'] =="Inactive")
{
 ...
 OR taxablevalue LIKE '%".$_POST['search']."%'
 OR totalcgst LIKE '%".$_POST['search']."%'
 OR totalsgst LIKE '%".$_POST['search']."%'
 OR totaligst LIKE '%".$_POST['search']."%'
...
foreach ($result as $row) {
    ...
    $sub_array[] = $row['taxablevalue'];
    $sub_array[] = $row['totalcgst'];
    $sub_array[] = $row['totalsgst'];
    $sub_array[] = $row['totaligst'];
	...
	$action="<a href='editbilling5&upd=$id' title='Edit details'><span class='icon-border_color'></span></a>&nbsp;&nbsp; 
	<a href='editbilling5&del=$id' title='Edit details'><span class='icon-trash-2'></span></a>";
