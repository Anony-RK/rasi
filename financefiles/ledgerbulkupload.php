...
<form action="" method="post" enctype="multipart/form-data" name="ledgerbulk" id="ledgerbulk">
<div class="card-body">
...
<div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-12">
<button type="submit" name="submitledgerbulkbtn" id="submitledgerbulkbtn" class="btn btn-primary  form-control"><span class="icon-upload"></span>&nbsp Upload</button>
</div>
<div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-12">
</div>
</div>
<br />			    
		...
		<script type="text/javascript">
			$(document).ready(function(e){
			 $("#ledgerbulk").on('submit', function(e){
			 	e.preventDefault();
			 	 $.ajax({
			 	 	type: 'POST',
			 	 	url: 'ledgerdatabulkupload.php',
