...
<div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-12">
<button type="submit" name="submitcustomerbulkbtn" id="submitcustomerbulkbtn" class="btn btn-primary  form-control"><i class="fas fa-upload"></i>&nbsp Upload</button>
</div>
<div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-12">
</div>
</div>
<br />			    
		...
		$(document).ready(function(e){
			$("#insertsuccess").hide();
			 $("#customerbulk").on('submit', function(e){
			 	...
			 	e.preventDefault();
			 	 $.ajax({
                    ...
                    $('#submitcustomerbulkbtn').attr("disabled", true);
                    },
                    ...
                    $('#submitcustomerbulkbtn').attr("disabled", false);
                    $("#insertsuccess").show();
			 	 	}
			 	 });
			 	});
