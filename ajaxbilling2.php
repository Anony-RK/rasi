...
foreach ($result as $row) {
	...
	$action="<a href='editbilling2&upd=$id' title='Edit details'><span class='icon-border_color'></span></a>&nbsp;&nbsp; 
	<a href='editbilling2&del=$id' title='Edit details'><span class='icon-trash-2'></span></a>";
