...
"<td><input type='date'  class='form-control  date' name='date[]' id='date'  placeholder='0.0' /></td>" +
...
$('#branchoutward').find('tbody').append(appendTxt);
}
});
...
success: function (data) {   
   ...
   var table = document.getElementById("branchoutward");
...
//    var row = table.insertRow(rowCount);
   ...
   "<td><input type='number'  class='form-control total' readonly  name='total[]' placeholder='0' id='total' /></td>" +
   "<td><input type='date'  class='form-control  discount' name='discount[]' id='discount'  placeholder='0.0' /></td>" +
