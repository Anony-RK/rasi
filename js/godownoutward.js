...
"<td><input  type='number'  class='form-control col-xs-12 col-sm-12 descrb description'  id='description' name='description[]' /></td>" +
"<td><input  type='number'  class='form-control col-xs-12 col-sm-12 orderedqty'  id='orderedqty' name='orderedqty[]'   /></td>" +
"<td><input type='number'  class='form-control shippingqty'   name='shippingqty[]' placeholder='0' id='shippingqty' /></td>" +
"<td><input type='number'  class='form-control  unitprice' name='unitprice[]' id='unitprice'  placeholder='0.0' /></td>" +
"<td><input type='number'  class='form-control  inputs totalamount' readonly  id='totalamount' name='totalamount[]' placeholder='0.0' /></td>" +
// "<td> 9%</td>"+
...
$('#godownoutward').find('tbody').append(appendTxt);
}
});
...
success: function (data) {   
   ...
   var table = document.getElementById("godownoutward");
...
$(document).on("keyup", '.unitprice', function (e){
    ...
    var  shippingqty= $(this).parent().parent().find(".shippingqty").val();

    totalamount = unitprice * shippingqty;
     $(this).parent().parent().find(".totalamount").val(totalamount);
